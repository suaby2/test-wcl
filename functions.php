...
function test_theme_scripts() {
	...
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/styles/css/bootstrap.css', array(), '5.0.0');
	wp_enqueue_script('theme-scipts', get_template_directory_uri() . '/assets/scripts/scripts.js', array('jquery'), '1.0', true);
